module TestPredictions
  def test_add_new_prediction
    post '/match/add_prediction',
         { match_id: '12', home_team_prediction: '98', away_team_prediction: '99' }, user_11_session
  ...
  def test_change_prediction
    post '/match/add_prediction',
         { match_id: '11', home_team_prediction: '98', away_team_prediction: '99' }, user_11_session
  ...
  def test_add_decimal_prediction
    post '/match/add_prediction',
         { match_id: '11', home_team_prediction: '2.3', away_team_prediction: '3' }, user_11_session_with_all_criteria
  ...
  def test_add_negative_prediction
    post '/match/add_prediction',
         { match_id: '11', home_team_prediction: '-2', away_team_prediction: '3' }, user_11_session_with_all_criteria
  ...
  def test_add_prediction_lockeddown_match
    post '/match/add_prediction',
         { match_id: '1', home_team_prediction: '2', away_team_prediction: '3' }, user_11_session_with_all_criteria
