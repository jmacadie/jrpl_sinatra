module TestResults
  def test_add_new_result
    post '/match/add_result', { match_id: '3', home_pts: '98', away_pts: '99' },
         admin_session
  ...
  def test_change_result
    post '/match/add_result', { match_id: '2', home_pts: '98', away_pts: '99' },
         admin_session
  ...
  def test_add_decimal_result
    post '/match/add_result', { match_id: '3', home_pts: '2.3', away_pts: '3' },
  ...
  def test_add_negative_result
    post '/match/add_result', { match_id: 3, home_pts: '-2', away_pts: '3' },
         admin_session_with_all_criteria
  ...
  def test_add_result_not_lockeddown_match
    post '/match/add_result', { match_id: '64', home_pts: '2', away_pts: '3' },
         admin_session_with_all_criteria
