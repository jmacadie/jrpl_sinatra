module TestScoreboard
  ...
  def test_scoreboard_change_result
    post '/match/add_result', { match_id: 7, home_pts: '2', away_pts: '1' },
         admin_session
  ...
  def test_scoreboard_add_result
    post '/match/add_result', { match_id: 6, home_pts: '2', away_pts: '1' },
         admin_session
  ...
  def test_autoquiz_scoreboard
    get '/toggle_scoring_system', { scoring_system: 'autoquiz' },
        user_11_session
